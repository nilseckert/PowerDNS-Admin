...
Revision ID: 19e9bebf6d01
Revises: 
Create Date: 2018-06-23 01:21:08.453910
...
def upgrade():
    ...
    role_table = sa.sql.table('setting', 
        sa.Column('name', sa.String),
    ...
    op.bulk_insert(
        role_table,
        [
            {'name':'maintenance', 'value':'Administrator'},
            {'name':'fullscreen_layout', 'value':'True'},
            {'name':'record_helper', 'value':'True'},
            {'name':'login_ldap_first', 'value':'True'},
            {'name':'default_record_table_size', 'value':'15'},
            {'name':'default_domain_table_size', 'value':'10'},
            {'name':'auto_ptr', 'value':'False'},
        ]
    )
